...
public interface CommentGenerator {
     ...
     *
     * <p>
     * <b>Important:</b> This method should add a the nonstandard JavaDoc tag "@mbg.generated" to the
     ...
     * entire class in case any manual changes have been made. So this method will always use the "do
     ...
     * @param introspectedColumn the introspected column
     */
    void addGetterComment(Method method, IntrospectedTable introspectedTable,
                          IntrospectedColumn introspectedColumn);
     ...
     * @param introspectedColumn the introspected column
     */
    void addSetterComment(Method method, IntrospectedTable introspectedTable,
                          IntrospectedColumn introspectedColumn);
     ...
     * @param method the method
     * @param introspectedTable the introspected table
     * @param introspectedColumn introspected column thr introspected column
     * @param imports the comment generator may add a required imported type to this list
     *
     * @since 1.3.6
     */
