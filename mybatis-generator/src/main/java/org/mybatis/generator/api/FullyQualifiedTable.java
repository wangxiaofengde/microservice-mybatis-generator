...
public class FullyQualifiedTable {
     ...
     *        different catalog.
     * @param runtimeSchema this is used to "rename" the schema in the generated SQL. This is useful,
     *        for example, when generating code against one schema that should run with a different
     *        schema.
     ...
     * @param delimitIdentifiers if true, then the table identifiers will be delimited at runtime. The
     *        delimiter characters are obtained from the Context.
     ...
     *        object renameing rule to generate the final domain object name.
    ...
    public FullyQualifiedTable(String introspectedCatalog, String introspectedSchema,
                               ...
                               String runtimeTableName, boolean delimitIdentifiers,
    ...
    public String toString() {
        return composeFullyQualifiedTableName(introspectedCatalog, introspectedSchema,
     ...
     *
     * <p>
     * This method is used for determining the sub package for Java client and SQL map (XML) objects.
     * It ignores any sub-package added to the domain object name in the table configuration.
     *
     ...
     *
     * <p>
     * This method is used for determining the sub package for Java model objects only. It takes into
     * account the possibility that a sub-package was added to the domain object name in the table
     * configuration.
     *
     * @param isSubPackagesEnabled the is sub packages enabled
     * @return the subpackage for this table
