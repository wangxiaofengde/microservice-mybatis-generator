...
public class Ibatis2FormattingUtilities {
   ...
   * appropriate for selects in SqlMaps because the column is not escaped for iBATIS. If there is a
   * table alias, the value will be alias.columnName.
   * 
   * <p>
   * This method is used in the Example classes and the returned value will be in a Java string. So
