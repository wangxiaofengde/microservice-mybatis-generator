...
public class ExampleGenerator extends AbstractJavaGenerator {
  ...
  public List<CompilationUnit> getCompilationUnits() {
    ...
    this.progressCallback.startTask(getString("Progress.6", table.toString())); //$NON-NLS-1$
    ...
    if (commentGenerator instanceof CustomizationCommentGenerator) {
      ((CustomizationCommentGenerator) commentGenerator).addExampleClassComment(topLevelClass,
    ...
    if (this.context.getPlugins().modelExampleClassGenerated(topLevelClass,
        this.introspectedTable)) {
  ...
  private InnerClass getGeneratedCriteriaInnerClass(TopLevelClass topLevelClass) {
    ...
    // deal field method
    answer.addMethod(this.getFieldNoValueMethod("IsNull", "is null"));
    answer.addMethod(this.getFieldNoValueMethod("IsNotNull", "is not null"));
    answer.addMethod(this.getFieldSingleValueMethod("EqualTo", "="));
    answer.addMethod(this.getFieldSingleValueMethod("NotEqualTo", "<>"));
    answer.addMethod(this.getFieldSingleValueMethod("GreaterThan", ">"));
    answer.addMethod(this.getFieldSingleValueMethod("GreaterThanOrEqualTo", ">="));
    answer.addMethod(this.getFieldSingleValueMethod("LessThan", "<"));
    answer.addMethod(this.getFieldSingleValueMethod("LessThanOrEqualTo", "<="));
    answer.addMethod(this.getFieldSingleValueMethod("Like", "like"));
    answer.addMethod(this.getFieldSingleValueMethod("NotLike", "not like"));
    answer.addMethod(this.getFieldSetInOrNotInMethod(true));
    answer.addMethod(this.getFieldSetInOrNotInMethod(false));
    answer.addMethod(this.getFieldSetBetweenOrNotBetweenMethod(true));
    answer.addMethod(this.getFieldSetBetweenOrNotBetweenMethod(false));

    return answer;
  }

  private Method getFieldNoValueMethod(String nameFragment, String operator) {
    Method method = new Method();
    method.setVisibility(JavaVisibility.PUBLIC);
    FullyQualifiedJavaType stringJavaType = new FullyQualifiedJavaType("java.lang.String");
    method.addParameter(new Parameter(stringJavaType, "fieldName")); //$NON-NLS-1$
    StringBuilder sb = new StringBuilder();
    sb.append("field");
  ...
  private Method getFieldSingleValueMethod(String nameFragment, String operator) {
    Method method = new Method();
    method.setVisibility(JavaVisibility.PUBLIC);
    FullyQualifiedJavaType stringJavaType = new FullyQualifiedJavaType("java.lang.String");
    method.addParameter(new Parameter(stringJavaType, "fieldName"));
    FullyQualifiedJavaType objectJavaType = new FullyQualifiedJavaType("java.lang.Object");
    method.addParameter(new Parameter(objectJavaType, "fieldValue"));
    StringBuilder sb = new StringBuilder();
    sb.append("field");
    sb.setCharAt(0, Character.toUpperCase(sb.charAt(0)));
    sb.insert(0, "and"); //$NON-NLS-1$
    ...
    sb.append(operator);
    sb.append("\", "); //$NON-NLS-1$
    sb.append("fieldValue"); //$NON-NLS-1$
    sb.append(", \""); //$NON-NLS-1$
    sb.append("fieldName");
    sb.append("\");"); //$NON-NLS-1$
    method.addBodyLine(sb.toString());
  ...
  private Method getFieldSetInOrNotInMethod(boolean inMethod) {
    Method method = new Method();
    method.setVisibility(JavaVisibility.PUBLIC);
    FullyQualifiedJavaType stringJavaType = new FullyQualifiedJavaType("java.lang.String");
    method.addParameter(new Parameter(stringJavaType, "fieldName"));
    ...
    FullyQualifiedJavaType objectJavaType = new FullyQualifiedJavaType("java.lang.Object");
    type.addTypeArgument(objectJavaType);
    method.addParameter(new Parameter(type, "fieldValues")); //$NON-NLS-1$
    StringBuilder sb = new StringBuilder();
    sb.append("field");
    sb.setCharAt(0, Character.toUpperCase(sb.charAt(0)));
    sb.insert(0, "and"); //$NON-NLS-1$
    ...
    sb.append("\", fieldValues, \""); //$NON-NLS-1$
    sb.append("fieldName");
    sb.append("\");"); //$NON-NLS-1$
    method.addBodyLine(sb.toString());
    method.addBodyLine("return (Criteria) this;"); //$NON-NLS-1$
  ...
  private Method getFieldSetBetweenOrNotBetweenMethod(boolean betweenMethod) {
    Method method = new Method();
    method.setVisibility(JavaVisibility.PUBLIC);
    FullyQualifiedJavaType stringJavaType = new FullyQualifiedJavaType("java.lang.String");
    method.addParameter(new Parameter(stringJavaType, "fieldName"));
    FullyQualifiedJavaType objectJavaType = new FullyQualifiedJavaType("java.lang.Object");
    method.addParameter(new Parameter(objectJavaType, "fieldValue1")); //$NON-NLS-1$
    method.addParameter(new Parameter(objectJavaType, "fieldValue2")); //$NON-NLS-1$
    StringBuilder sb = new StringBuilder();
    sb.append("field");
    sb.setCharAt(0, Character.toUpperCase(sb.charAt(0)));
    sb.insert(0, "and"); //$NON-NLS-1$
    ...
    sb.append("\", "); //$NON-NLS-1$
    sb.append("fieldValue1, fieldValue2"); //$NON-NLS-1$
    sb.append(", \""); //$NON-NLS-1$
    sb.append("fieldName");
    sb.append("\");"); //$NON-NLS-1$
    method.addBodyLine(sb.toString());
  ...
  private Method getSetNullMethod(IntrospectedColumn introspectedColumn) {
    return this.getNoValueMethod(introspectedColumn, "IsNull", "is null"); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetNotNullMethod(IntrospectedColumn introspectedColumn) {
    return this.getNoValueMethod(introspectedColumn, "IsNotNull", "is not null"); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetEqualMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "EqualTo", "="); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetNotEqualMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "NotEqualTo", "<>"); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetGreaterThanMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "GreaterThan", ">"); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetGreaterThenOrEqualMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "GreaterThanOrEqualTo", ">="); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetLessThanMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "LessThan", "<"); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetLessThanOrEqualMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "LessThanOrEqualTo", "<="); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetLikeMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "Like", "like"); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSetNotLikeMethod(IntrospectedColumn introspectedColumn) {
    return this.getSingleValueMethod(introspectedColumn, "NotLike", "not like"); //$NON-NLS-1$ //$NON-NLS-2$
  }

  private Method getSingleValueMethod(IntrospectedColumn introspectedColumn, String nameFragment,
      String operator) {
    Method method = new Method();
    method.setVisibility(JavaVisibility.PUBLIC);
