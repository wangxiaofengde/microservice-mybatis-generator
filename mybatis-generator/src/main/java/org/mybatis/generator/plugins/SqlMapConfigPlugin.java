 ...
 * This demonstrates hooking into the code generation lifecycle and generating additional XML files.
 *
 * <p>
 * This plugin accepts three properties:
 *
 * <ul>
 * <li><tt>fileName</tt> (optional) the name of the generated file. this defaults to
 * "SqlMapConfig.xml" if not specified.</li>
 * <li><tt>targetPackage</tt> (required) the name of the package where the file should be placed.
 * Specified like "com.mycompany.sql".</li>
 * <li><tt>targetProject</tt> (required) the name of the project where the file should be
 * placed.</li>
 * </ul>
 *
 * <p>
 * Note: targetPackage and targetProject follow the same rules as the targetPackage and
...
public class SqlMapConfigPlugin extends PluginAdapter {
    ...
    public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles() {
        ...
        GeneratedXmlFile gxf =
                new GeneratedXmlFile(document, properties.getProperty("fileName", "SqlMapConfig.xml"), //$NON-NLS-1$ //$NON-NLS-2$
