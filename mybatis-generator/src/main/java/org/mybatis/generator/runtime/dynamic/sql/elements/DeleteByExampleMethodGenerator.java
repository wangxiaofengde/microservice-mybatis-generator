...
public class DeleteByExampleMethodGenerator extends AbstractMethodGenerator {
    ...
    public MethodAndImports generateMethodAndImports() {
        ...
        imports.add(
                new FullyQualifiedJavaType("org.mybatis.dynamic.sql.delete.MyBatis3DeleteModelAdapter")); //$NON-NLS-1$
        ...
        method.addBodyLine(
                "return DeleteDSL.deleteFromWithMapper(this::delete, " + tableFieldName + ");"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public boolean callPlugins(Method method, Interface interfaze) {
        return context.getPlugins().clientDeleteByExampleMethodGenerated(method, interfaze,
                introspectedTable);
    }
