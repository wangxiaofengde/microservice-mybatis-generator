...
public class FragmentGenerator {
    ...
    public MethodParts getPrimaryKeyWhereClauseAndParameters() {
        ...
        for (IntrospectedColumn column : introspectedTable.getPrimaryKeyColumns()) {
            ...
            builder.withParameter(
                    new Parameter(column.getFullyQualifiedJavaType(), column.getJavaProperty() + "_")); //$NON-NLS-1$
            if (first) {
    ...
    private String getArgAnnotation(Set<FullyQualifiedJavaType> imports,
                                    IntrospectedColumn introspectedColumn, boolean idColumn) {
        StringBuilder sb = new StringBuilder();
    ...
    private String getResultAnnotation(Set<FullyQualifiedJavaType> imports,
                                       IntrospectedColumn introspectedColumn, boolean idColumn) {
        StringBuilder sb = new StringBuilder();
    ...
    public List<String> getSetEqualWhenPresentLines(List<IntrospectedColumn> columnList,
                                                    boolean terminate) {
        List<String> lines = new ArrayList<String>();
        List<IntrospectedColumn> columns =
                ListUtilities.removeIdentityAndGeneratedAlwaysColumns(columnList);
