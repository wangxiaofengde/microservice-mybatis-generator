...
public class SelectByExampleMethodGenerator extends AbstractMethodGenerator {
  ...
  public MethodAndImports generateMethodAndImports() {
    ...
    imports.add(
        new FullyQualifiedJavaType("org.mybatis.dynamic.sql.select.MyBatis3SelectModelAdapter")); //$NON-NLS-1$
  ...
  public boolean callPlugins(Method method, Interface interfaze) {
    return context.getPlugins().clientSelectByExampleWithBLOBsMethodGenerated(method, interfaze,
        introspectedTable);
  }
