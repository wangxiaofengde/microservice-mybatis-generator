...
public class FullyQualifiedJavaType implements Comparable<FullyQualifiedJavaType> {
  ...
  /**
   * Returns a list of Strings that are the fully qualified names of this type, and any generic type
   * argument associated with this type.
   *
   ...
   * 
   * <p>
   * This method calculates the package as the part of the fully qualified name up to, but not
   * including, the last element. Therefore, it does not support fully qualified inner classes. Not
