...
/**
 * Base class for DAO templates. Subclasses should override any of the configureXXX methods to
 * specify the unique properties of the desired DAO objects.
 * 
 * @author Jeff Butler
 */
public abstract class AbstractDAOTemplate {
  ...
  public final List<Method> getMethodClones(CommentGenerator commentGenerator,
      IntrospectedTable introspectedTable) {
    configure();
  ...
  /**
   * This method is called in the constructor to configure the DAO template. Subclasses should
   * implement the individual configureXXX methods to setup the relevant parts of the DAO template
  ...
  /**
   * Override this method to add checked exceptions to the throws clause of any generated DAO
   * method. When overriding this method, call
   * <code>addCheckedException(FullyQualifiedJavaType)</code> one or more times to add checked
   * exception(s) to all generated DAO methods.
   */
  protected void configureCheckedExceptions() {}

  /**
   * Override this method to add fields to any generated DAO implementation class. When overriding
   * this method, call <code>addField(Field)</code> one or more times to add field(s) to the
   * generated DAO implementation class.
   */
  protected void configureFields() {}

  /**
   * Override this method to add imports to generated DAO implementation classes. When overriding
   * this method, call <code>addImplementationImport(FullyQualifiedJavaType)</code> one or more
   * times to add import(s) to generated DAO implementation classes.
   */
  protected void configureImplementationImports() {}

  /**
   * Override this method to add imports to generated DAO interface classes. When overriding this
   * method, call <code>addInterfaceImport(FullyQualifiedJavaType)</code> one or more times to add
   * import(s) to generated DAO interface classes.
   */
  protected void configureInterfaceImports() {}

  /**
   * Override this method to add methods to generated DAO implementation classes. When overriding
   * this method, call <code>addMethod(Method)</code> one or more times to add method(s) to
   * generated DAO implementation classes.
   */
  protected void configureMethods() {}

  /**
   * Override this method to set the superclass for any generated DAO implementation class. When
   * overriding this method call <code>setSuperClass(FullyQualifiedJavaType)</code> to set the
   ...
   * During code generation, we will build a new constructor using the visibility, parameters, body
   * lines, and exceptions set on the constructor template. When overriding this method, call
  ...
  /**
   * Override this method to configure an insert method template. A method template is a string with
   * three substitution markers that we will fill in when generating code. The substitution markers
   * will be:
   * <ul>
   ...
   * 
   * <p>
   * Overriding methods should call the <code>setInsertMethodTemplate(String)</code> method to set
   * the template.
   * 
   */
  ...
  /**
   * Override this method to configure a queryForList method template. A method template is a string
   * with three substitution markers that we will fill in when generating code. The substitution
   * markers will be:
   * <ul>
   * <li>{0} - The SqlMap namespace</li>
   * <li>{1} - The SqlMap statement id</li>
   ...
   * 
   * <p>
   * Overriding methods should call the <code>setQueryForListMethodTemplate(String)</code> method to
   * set the template.
   */
  protected abstract void configureQueryForListMethodTemplate();

  /**
   * Override this method to configure a queryForObject method template. A method template is a
   * string with three substitution markers that we will fill in when generating code. The
   ...
   * 
   * <p>
   * Overriding methods should call the <code>setQueryForObjectMethodTemplate(String)</code> method
   * to set the template.
   */
  protected abstract void configureQueryForObjectMethodTemplate();

  /**
   * Override this method to configure an update method template. A method template is a string with
   * three substitution markers that we will fill in when generating code. The substitution markers
   * will be:
   * <ul>
   * <li>{0} - The SqlMap namespace</li>
   ...
   * 
   * <p>
   * Overriding methods should call the <code>setUpdateMethodTemplate(String)</code> method to set
   * the template.
   */
  protected abstract void configureUpdateMethodTemplate();

  /**
   * Override this method to configure a delete method template. A method template is a string with
   * three substitution markers that we will fill in when generating code. The substitution markers
   * will be:
   * <ul>
   * <li>{0} - The SqlMap namespace</li>
   ...
   * 
   * <p>
   * Overriding methods should call the <code>setDeleteMethodTemplate(String)</code> method to set
   * the template.
   */
