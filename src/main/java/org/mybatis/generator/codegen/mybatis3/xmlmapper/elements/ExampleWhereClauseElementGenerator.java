...
public class ExampleWhereClauseElementGenerator extends AbstractXmlElementGenerator {
  ...
  public void addElements(XmlElement parentElement) {
    ...
    if (this.isForUpdateByExample) {
      answer.addAttribute(
          new Attribute("id", this.introspectedTable.getMyBatis3UpdateByExampleWhereClauseId())); //$NON-NLS-1$
    } else {
      answer.addAttribute(new Attribute("id", this.introspectedTable.getExampleWhereClauseId())); //$NON-NLS-1$
    }
    ...
    if (this.context.getPlugins().sqlMapExampleWhereClauseElementGenerated(answer,
