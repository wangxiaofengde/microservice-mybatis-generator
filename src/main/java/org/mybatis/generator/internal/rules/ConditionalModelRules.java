...
public class ConditionalModelRules extends BaseRules {
  ...
  public boolean generateBaseRecordClass() {
    return introspectedTable.hasBaseColumns()
        || introspectedTable.getPrimaryKeyColumns().size() == 1 || blobsAreInBaseRecord();
  }
  ...
  /**
   * We generate a record with BLOBs class if there is more than one BLOB column. Do not generate a
   * BLOBs class if any other super class would only contain one field
   * 
