...
public final class HashCodeUtil {
  ...
  public static int hash(int seed, int i) {
    /*
     * Implementation Note Note that byte and short are handled by this method, through implicit
     * conversion.
     */
   ...
   * 
   * <p>
   * If <code>aObject</code> is an array, then each element may be a primitive or a possibly-null
   * object.
   *
   * @param seed the seed
   * @param o the object
