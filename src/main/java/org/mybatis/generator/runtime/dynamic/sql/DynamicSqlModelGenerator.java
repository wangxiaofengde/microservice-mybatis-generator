...
/**
 * This model generator builds a flat model qith default constructor and getters/setters. It does
  ...
  public List<CompilationUnit> getCompilationUnits() {
    ...
    if (this.introspectedTable.isConstructorBased()) {
      ...
      if (!this.introspectedTable.isImmutable()) {
        Method method = this.getDefaultConstructor(topLevelClass);
        method.getJavaDocLines().clear();
        commentGenerator.addGeneralMethodAnnotation(method, this.introspectedTable,
    ...
    for (IntrospectedColumn introspectedColumn : introspectedColumns) {
      ...
      commentGenerator.addFieldAnnotation(field, this.introspectedTable, introspectedColumn,
          topLevelClass.getImportedTypes());
      ...
      method.getJavaDocLines().clear();
      commentGenerator.addGeneralMethodAnnotation(method, this.introspectedTable,
          introspectedColumn, topLevelClass.getImportedTypes());
