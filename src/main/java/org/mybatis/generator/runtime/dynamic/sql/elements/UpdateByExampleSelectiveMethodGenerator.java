...
public class UpdateByExampleSelectiveMethodGenerator extends AbstractMethodGenerator {
  ...
  public MethodAndImports generateMethodAndImports() {
    ...
    method.addBodyLines(
        fragmentGenerator.getSetEqualWhenPresentLines(introspectedTable.getAllColumns(), true));
  ...
  public boolean callPlugins(Method method, Interface interfaze) {
    return context.getPlugins().clientUpdateByExampleSelectiveMethodGenerated(method, interfaze,
        introspectedTable);
  }
